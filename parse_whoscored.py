...
def parse_yc_rc_goals(xpath_to_stat, driver):
    ...
    rc_until_45 = 0
    rc_60_ft = 0
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, xpath_to_stat)))
...
def parse_live_table(driver):
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, xpath_raiting_team_home)))
    ...
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, xpath_woodwork_home)))
    ...
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, xpath_touches_home)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_accurate_passes_away)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_dribbled_past_home)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_offensive_aerials_away)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_interceptions_away)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_corner_accuracy_home)))
    ...
    action.double_click(elem)
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,xpath_fouls_away)))
...
def parse_chalkboard(driver):
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, xpath_to_shots_chalkboard)))
    ...
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, shots_situation_fastbreak_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, passes_throw_in_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,dribbles_unsuccessful_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,tackles_was_dribbled_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH,clearances_body_parts_feet_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, blocked_crosses_home)))
    ...
    action.click()
    action.perform()
    wait_res = WebDriverWait(driver, 20).until(element_has_text((By.XPATH, errors_leads_to_goal_home)))
...
def parse_probable_stat(driver):
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, css_probable_stat_goals_home)))
...
def parse_characteristic(driver):
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, xpath_to_strongs_home)))
...
def parse_whoscored(url, driver, db):
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, xpath_team_home)))
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, css_season)))
    ...
    try:
        ...
        wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, css_to_time_scroll)))
        action = ActionChains(driver)
    ...
    wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.XPATH, referee)))
...
##    driver.execute_script(script_scroll_down, 1100)
    ...
    # 1 to 45
    try:
        wait_res = WebDriverWait(driver, 20).until(EC.presence_of_element_located((By.CSS_SELECTOR, css_to_time_scroll_chalkboard)))
